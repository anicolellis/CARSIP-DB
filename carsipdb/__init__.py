...
def main() -> None:
    ...
    with Session(ENGINE) as session, session.begin():
        ...
        test_device = Device(location_id=1,
                             ...
                             create_time=datetime.datetime.now())
        #Computer
        test_computer = Computer(device_id=1,
                                 cpu_id=1,
                                 bios_version="2.48.0",
                                 ...
                                 create_time=datetime.datetime.now())
        #DNS
        test_dns = DNS(name="Test",
                       ip_address="1.2.3.4",
                       modify_time=datetime.datetime.now(),
                       create_time=datetime.datetime.now())
        #DHCP
        test_dhcp = DHCP(device_id=1,
                         dns_id=1,
                         name="Test",
                         ...
                         create_time=datetime.datetime.now())
        #Interface
        test_interface = Interface(device_id=1,
                                   ...
                                   create_time=datetime.datetime.now())
        #MemorySlot
        test_mem_slot = MemorySlot(computer_id=1,
                                   memory_id=1,
                                   slot_number=0,
                                   modify_time=datetime.datetime.now(),
                                   create_time=datetime.datetime.now())
        #PhysicalDisk
        test_disk = PhysicalDisk(computer_id=1,
                                 physical_disk_type_id=1,
                                 smart_status="OK",
                                 firmware="1.0.",
                                 modify_time=datetime.datetime.now(),
                                 create_time=datetime.datetime.now())
        #Volume
        test_volume = Volume(physical_disk_id=1,
                             capacity=952.6,
                             file_system="NTFS",
                             usage="17%",
                             modify_time=datetime.datetime.now(),
